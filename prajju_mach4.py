...
def open_image():
    ...
    if file_path:
        ...
        gray_image = cv2.cvtColor(image_array_squeezed, cv2.COLOR_BGR2GRAY)
        input_data_reshaped = gray_image.reshape(28, 28, 1)
